...
//      a. Keep the money from the (i-1)th (previous) house, skipping
//      the ith house 
//      b. Rob the ith house after the (i-2)th house, skipping the
//      (i-1)th
...
class Solution {
    ...
    public int solve(int[] nums, int start, int end) {
        ...
        for (int i = start + 2; i <= end; ++i)
            ...
            // 2. Rob it after the (i-2)th house, skipping the (i-1)th
            // house We choose the one that gives the max amount
